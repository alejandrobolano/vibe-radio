import { Broadcast, ClockCounterClockwise, Compass, Heart } from '@phosphor-icons/react'
...
export function DirectoryHeader({ view, favoriteCount, sleepTimer, onHome, onViewChange }: DirectoryHeaderProps) {
  return (
